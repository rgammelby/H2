...
// changed from onload to a function to stop it from playing immediately upon load
...
// changed background colour styling so the confetti canvas doesn't render the page invisible
